...
PML_sol1 = f'PML_acoustic_buoyancy_beta_{beta1}_gamma0_{gamma}'
PML_sol2 = f'PML_acoustic_buoyancy_beta_{beta2}_gamma0_{gamma}'
PML_sol3 = f'PML_acoustic_buoyancy_gamma0_{gamma}'
PML_sol4 = f'PML_acoustic_buoyancy_beta_{beta4}_gamma0_{gamma}'
PML_sol5 = f'PML_acoustic_buoyancy_beta_{beta5}_gamma0_{gamma}'
...
savename = f'{figure_stem}acoustic_buoyancy_compare_PML_errors_diff_beta_{field_name}'
...
plt.figure()
plt.semilogy(time[t_min:], PML_errs1[t_min:], label=r'$\beta$ = 10$^{-1}$')
plt.semilogy(time[t_min:], PML_errs2[t_min:], label=r'$\beta$ = 10$^{-2}$')
plt.semilogy(time[t_min:], PML_errs3[t_min:], label=r'$\beta$ = 10$^{-3}$')
plt.semilogy(time[t_min:], PML_errs4[t_min:], label=r'$\beta$ = 10$^{-4}$')
plt.semilogy(time[t_min:], PML_errs5[t_min:], label=r'$\beta$ = 10$^{-5}$')
