...
# PML parameters. 
# Vary beta, the PML tolerance
tol = 1e-5
gamma0 = 0.25

savename = f'PML_acoustic_buoyancy_beta_{tol}_gamma0_{gamma0}'
...
PML_pars = PMLParameters(mesh, H=domain_height, gamma0=gamma0, tol=tol)
