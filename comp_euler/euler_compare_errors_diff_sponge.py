...
####################################
# Reference solution:
ref_sol = 'euler_acoustic_ref_36000.0'
...
sponge_sol1 = f'euler_sponge_acoustic_mudt_{mudt1}'
sponge_sol2 = f'euler_sponge_acoustic_mudt_{mudt2}'
sponge_sol3 = f'euler_sponge_acoustic_mudt_{mudt3}'
sponge_sol4 = f'euler_sponge_acoustic_mudt_{mudt4}'
sponge_sol5 = f'euler_sponge_acoustic_mudt_{mudt5}'
...
savename = f'{figure_stem}euler_compare_sponge_diff_mudt_{field_name}'
...
# Time values:
time = ref_data['time']
print(len(ref_data['time']))
print(len(sponge_data1['time']))
print(len(sponge_data2['time']))
print(len(sponge_data3['time']))
print(len(sponge_data4['time']))
print(len(sponge_data5['time']))
