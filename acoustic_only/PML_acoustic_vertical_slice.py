...
savename = 'PML_acoustic_A6'
#savename = 'PML_acoustic_with_gamma_z'
...
# Default parameters, with no grid stretching
#PML_pars = PMLParameters(mesh, H=domain_height, delta_frac = 0.1, c_max=cs, gamma0=0.0)
