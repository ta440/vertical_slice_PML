...
sponge_sol1 = f'bous_mount_sponge_acoustic_mudt_{mudt1}'
sponge_sol2 = f'bous_mount_sponge_acoustic_mudt_{mudt2}'
sponge_sol3 = f'bous_mount_sponge_acoustic_mudt_{mudt3}'
sponge_sol4 = f'bous_mount_sponge_acoustic_mudt_{mudt4}'
sponge_sol5 = f'bous_mount_sponge_acoustic_mudt_{mudt5}'
...
savename = f'{figure_stem}bous_compare_sponge_diff_mudt_{field_name}'
