...
results_dir = 'z_transport'
#results_dir = 'acoustic_wave_vert_slice_no_sponge_ssprk3_short'
#results_dir = 'acoustic_wave_vert_slice_no_sponge_fe_short'
extra_name = ''

#field_name = 'q_u_z'
field_name = 'f'

results_file_name = f'../transport_tests/results/{results_dir}/field_output.nc'
video_stem = f'../transport_tests/videos/'
